...
-x : Move NotepadFree to indicated left side position on the screen\r\
-y : Move NotepadFree to indicated top position on the screen\r\
-monitor: Open file with file monitoring enabled\r\
-nosession : Launch NotepadFree without previous session\r\
-notabbar : Launch NotepadFree without tabbar\r\
-ro : Make the filePath read only\r\
-systemtray : Launch NotepadFree directly in system tray\r\
-loadingTime : Display NotepadFree loading time\r\
-alwaysOnTop : Make NotepadFree always on top\r\
...
-quickPrint : Print the file given as argument then quit NotepadFree\r\
...
-titleAdd=\"string\": add string to NotepadFree title bar\r\
...
public:
	...
	static HWND gNppHWND;	//static handle to NotepadFree window, NULL if non-existant
